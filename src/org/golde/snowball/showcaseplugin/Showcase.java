...
public class Showcase extends JavaPlugin implements Listener, TabCompleter {
	...
	private static Showcase showcaseInstance;
	
	public void onEnable() {
		showcaseInstance = this;
		...
		if(Bukkit.getPluginManager().isPluginEnabled("HolographicDisplays")) {
			HologramsAPI.registerPlaceholder(showcaseInstance, "sb_lastkey", 0.1, hd_key = new SBPlaceholderReplacer("sb_key"));
			HologramsAPI.registerPlaceholder(showcaseInstance, "sb_lastgui", 0.1, hd_key_gui = new SBPlaceholderReplacer("sb_gui"));
		}
